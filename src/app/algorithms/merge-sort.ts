...
export async function mergeSortRecursive(visualizer: SortingVisualizerComponent, array: SortBarInterface[], start: number, end: number): Promise<void> {
  ...
  const cloned: SortBarInterface[] = Array(end - start).fill(array[0]);
