...
export async function msdRadixSort(visualizer: SortingVisualizerComponent, array: SortBarComponent[], max: number): Promise<void> {
  let maxCount: number = max.toString().length;
  array.forEach(elem => {
